	...
	<div align="center">
		...
		<form method="post" action="<%=request.getContextPath() %>/board_update_ok.do">
			...
			<table border="1" cellspacing="0" width="400">
				<tr>
					<th>작성자</th>
					<td> <input tyep="text" name="board_writer" value="${dto.getBoard_writer() }" readonly> </td>
				</tr>
				<tr>
					<th>글제목</th>
					<td> <input tyep="text" name="board_title" value="${dto.getBoard_title() }"> </td>
				</tr>
				<tr>
					<th>글내용</th>
